...
```
docker tag test_docker_lambda:latest 255172291864.dkr.ecr.ap-southeast-1.amazonaws.com/test_lambda_docker:latest
docker push 255172291864.dkr.ecr.ap-southeast-1.amazonaws.com/test_lambda_docker:latest
```